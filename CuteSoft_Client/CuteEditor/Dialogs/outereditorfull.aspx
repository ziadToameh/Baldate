...
<script runat="server">
	...
	void SetMouseEvents(WebControl control)
	{
		...
		var OxOb3ed=["postback","Save"];function doClose(){Window_SetDialogReturnValue(window,null);Window_CloseDialog(window);} ;function CuteEditor_OnCommand(editor,Ox4d,Ox4e,Ox4f){if(Ox4d.toLowerCase()==OxOb3ed[0]&&Ox4f==OxOb3ed[1]){Window_SetDialogReturnValue(window,'<%= Request.QueryString["f"]%>');Window_CloseDialog(window);} ;} ;
	</script>