...
<fieldset><legend>[[Size]]</legend>
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		<tr>
			...
			<td nowrap><input type="text" id="tb_top" style="width:40px" />
			...
			<td nowrap><input type="text" id="tb_height" style="width:40px" />
		...
		<tr>
			...
			<td nowrap><input type="text" id="tb_left" style="width:40px" />
			...
			<td nowrap><input type="text" id="tb_width" style="width:40px" />
