...
var OxOc26f=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOc26f[1],true)[OxOc26f[0]]=function (){if(event[OxOc26f[2]]){alert(element[OxOc26f[3]].cssText);} ;} ;
</script>
