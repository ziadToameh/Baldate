<%@ WebHandler Language="C#" Class="UploadHandlerEvents" %>

using System;
using System.IO;
using System.Web;

public class UploadHandlerEvents : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) 
    {
        ...
        var tempPath = System.Configuration.ConfigurationManager.AppSettings["FolderEventPath"] + @"\" + id.ToString();
