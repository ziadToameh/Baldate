...
public partial class Admin_HomeAdImageDelete : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (isprofile != 0)
        {
            ...
            {
                string tempPath = "";
                tempPath = System.Configuration.ConfigurationManager.AppSettings["FolderEventProfilePath"] + @"\" +
                           id + @"\" + imageName;
            ...
            {
                Session["HomeAdResult"] = "Error Deleting the Image !";
            }
        }
        else
        {
            ...
            {
                rep.Delete(image);
                Session["HomeAdResult"] = "The Image was Deleted Successfully";
            }
            catch
            {
                Session["HomeAdResult"] = "Error Deleting the Image !";
        ...
        Response.Redirect("HomeAdImage.aspx?eventId=" + id + "&catId=" + catId);
