                ...
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <a href="ArticleEdit.aspx?id=<%# Eval("Id")%>">edit</a>
                            </td>
                            <td>
                                <a href="ArticleDelete.aspx?id=<%# Eval("Id")%>" onclick="return confirm('Are you sure you want to delete?')">
                                    delete</a>
                            </td>
                            <td>
                                <a href="ArticleImage.aspx?articleid=<%# Eval("Id")%>">Browse</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
