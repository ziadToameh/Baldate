<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="EventAllComments.aspx.cs" Inherits="Admin_EventAllComments" %>
        ...
        <table id="TableList" width="100%" align="center" cellpadding="0" cellspacing="0"
            ...
            <thead>
                <tr>
                    <th></th>
                    <th>
                        <asp:Label Width="100px" ID="Label5" Text="Event" runat="server"></asp:Label>
                    </th>
                    <th>
                ...
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%# ApproveLink(bool.Parse(Eval("IsActivated").ToString()), Eval("Id").ToString(), Eval("EventId").ToString())%>
                            </td>
                            <td>
                                <%# DisApproveLink(bool.Parse(Eval("IsActivated").ToString()), Eval("Id").ToString(), Eval("EventId").ToString())%>
                            </td>
                            <td>
                                <a href="EventCommentDelete.aspx?id=<%# Eval("Id")%>&eId=<%# Eval("EventId") %>" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
