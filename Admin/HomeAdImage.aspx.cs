...
public partial class Admin_HomeAdImage : System.Web.UI.Page
{
    ...
    public void Bind()
    {
        ...
        imgProfile.ImageUrl = ConfigurationManager.AppSettings["FolderEventProfilePath"] + "/" + e.Id + "/" + e.ProfileImage;
