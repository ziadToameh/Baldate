<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"
    CodeFile="EventEdit.aspx.cs" Inherits="Admin_EventEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <table>
            ...
            <tr>
                <td valign="middle">
                    <b><asp:Label ID="Label2" Text="Details" runat="server"></asp:Label></b>
                </td>
                <td>
            ...
            <tr>
                <td>
                   <b> <asp:Label ID="Label3" Text="Arabic Name" runat="server"></asp:Label></b>
                </td>
                <td>
