<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" validateRequest="false"
    ...
    <div>
        <table>
           ...
           <%-- <tr>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label3" Text="Arabic Name" runat="server"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td valign="bottom">
                    <asp:Label ID="Label4" Text="Arabic Details" runat="server"></asp:Label>
                </td>
                <td>
