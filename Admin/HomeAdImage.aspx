<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="HomeAdImage.aspx.cs" Inherits="Admin_HomeAdImage" %>
        ...
        <table width="90%" cellpadding="0" cellspacing="0" id="tblEventImage">
            ...
            <tr>
                <td align="center" id="tdProfile" runat="server">
                    ...
                    <br />
                    <a href="HomeAdImageDelete.aspx?eventId=<%= id %>&name=<%= ImgNameProfile %>&imgType=1&catId=<%= Cat %>&isprofile=1"
