<%@ Page Title="" Language="C#" MasterPageFile="~/ReporterList.master" AutoEventWireup="true" CodeFile="ReporterImage.aspx.cs" Inherits="ReporterImage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <link href="<%= ResolveUrl("Admin/CSS/uploadify.css") %>" rel="stylesheet" type="text/css" />
  ...
  <script type="text/javascript">
    ...
    function SetSource(id, name) {
      var source = 'Admin/Uploads/Events/' + '<%= id %>' + '/' + name;
          $('#' + id).attr('src', source);
        }
  </script>
  ...
  <div id="divList">
    <table width="90%">
      <tr>
        ...
        <td align="right">
          <a href="ReporterList.aspx?id=<%= Cat %>">
            <img src="Admin/CSS/images/back.png" width="30px" height="30px" style="border: 0" />
            Back to List</a>
        </td>
      </tr>
    </table>
    <table width="90%" cellpadding="0" cellspacing="0" id="tblEventImage">
      ...
      <tr>
        <td align="center" id="tdProfile" runat="server">
          ...
          <br />
          <a href="ReporterImageDelete.aspx?eventId=<%= id %>&name=<%= ImgNameProfile %>&imgType=1&catId=<%= Cat %>&isprofile=1"
    ...
    <table width="100%">
      <tr>
        <td valign="top" id="tdUploader" runat="server">
          ...
          <br />
          <div style="width: 140px; margin-right: 290px; margin-left: 100px; background-color: #000; padding: 7px 10px 7px 40px;">
              ...
              <asp:Repeater ID="Images" runat="server">
                <ItemTemplate>
                  <td>
                    ...
                    <br />
                    <a href="ReporterImageDelete.aspx?eventId=<%# Eval("EventId")%>&imageId=<%# Eval("Id")%>&catId=<%= Cat%>"
    ...
    function OnGetIDSucceeded(result, userContext, methodName) {
      ...
      if (result != "") {
        ...
        $("#uploader").pluploadQueue({
          ...
          url: 'UploadHandlerReporter.ashx?eventId=' + $('#<%=eventId.ClientID %>').val(),
                    max_file_size: '10mb',
                    chunk_size: '1mb',
                    unique_names: true,
...
function () {
  ...
  $("#<%=FileUpload5.ClientID %>").fileUpload({
        ...
        'script': 'UploadProfileReporter.ashx?eventId=' + $('#<%=eventId.ClientID %>').val(),
            'folder': 'uploads',
