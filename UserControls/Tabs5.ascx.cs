...
public partial class UserControls_Tabs5 : System.Web.UI.UserControl
{
    ...
    public void GetData()
    {
        ...
        Baladi2.DataBind();
        //var health = rep.GetAllWithImagesByCatId((int)EventCategories.B3).OrderByDescending(n => n.Id).Take(5);
        //Baladi3.DataSource = health;
        //Baladi3.DataBind();
        //var sport = rep.GetHomeByCat((int)EventCategories.B4).OrderByDescending(n => n.Id).Take(5);
